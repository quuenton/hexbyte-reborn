...
public class GuiMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        new DiscordUtility().update("In main menu", "");
        this.buttons.clear();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RoundedUtility.drawRound((float)(sr.getScaledWidth() / 2 - 70), (float)(sr.getScaledHeight() / 2 - 50), 140.0F, 150.0F, 5.0F, new Color(0, 0, 0, 110));
        RenderUtility.drawBlur(() ->  RoundedUtility.drawRound((float)(sr.getScaledWidth() / 2 - 70), (float)(sr.getScaledHeight() / 2 - 50), 140.0F, 150.0F, 5.0F, new Color(0, 0, 0, 110)), 15);
        Fonts.sfbolt30.drawCenteredString("hexbyte reborn", (float)(sr.getScaledWidth() / 2), (float)(sr.getScaledHeight() / 2 - 30), -1);
        Fonts.sfbolt18.drawCenteredString("by apraxia & quuenton", (float)(sr.getScaledWidth() / 2), (float)(sr.getScaledHeight() / 2 - 10), -1);
        this.offset = 0.0F;
        for(Iterator var5 = this.buttons.iterator(); var5.hasNext(); this.offset += 20.0F) {
            String string = (String)var5.next();
            Fonts.medium14.drawCenteredString(string, (float)(sr.getScaledWidth() / 2), (float)(sr.getScaledHeight() / 2 - 40 + 34 + 20) + this.offset, -1);
            RoundedUtility.drawRound((float)(sr.getScaledWidth() / 2 - 55), (float)(sr.getScaledHeight() / 2 - 40 + 34 + 15) + this.offset, 110.0F, 15.0F, 3.0F,  HoverUtility.isHovered(mouseX, mouseY, (double)(sr.getScaledWidth() / 2 - 55), (double)((float)(sr.getScaledHeight() / 2 - 40 + 34 + 15) + this.offset), 110.0, 15.0) ? new Color(255, 255, 255, 18) : new Color(255, 255, 255, 10));
        }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        for(Iterator var5 = this.buttons.iterator(); var5.hasNext(); this.offset += 20.0F) {
            String string = (String)var5.next();
            if (HoverUtility.isHovered(mouseX, mouseY, (double)(sr.getScaledWidth() / 2 - 55), (double)((float)(sr.getScaledHeight() / 2 - 40 + 34 + 15) + this.offset), 110.0, 15.0)) {
